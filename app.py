...
SEARCH_EXPANSION = {
    "遘ｻ豌・: ["遘ｻ豌・, "migration", "migrant", "immigration"],
    "髮｣豌・: ["髮｣豌・, "refugee", "asylum", "asylum seeker"],
    "蝗ｽ蠅・: ["蝗ｽ蠅・, "border", "frontier"],
    "蠑ｷ蛻ｶ騾・ｄ": ["蠑ｷ蛻ｶ騾・ｄ", "deportation", "deport", "removal"],
    "騾・ｄ": ["騾・ｄ", "deportation", "deport", "return"],
    "荳肴ｳ慕ｧｻ豌・: ["荳肴ｳ慕ｧｻ豌・, "illegal migration", "illegal migrant", "irregular migration"],
    "迥ｯ鄂ｪ": ["迥ｯ鄂ｪ", "crime", "criminal", "violence"],
    "證ｴ蜍・: ["證ｴ蜍・, "riot", "unrest", "violence"],
    "邨ｱ蜷・: ["邨ｱ蜷・, "integration"],
    "遘ｻ豌大鵠螳・: ["遘ｻ豌大鵠螳・, "migration pact", "EU migration pact"],
}
...
def clean_news_row(row):
    ...
    display_title = display_title.replace("鄙ｻ險ｳ貂医∩_", "")
